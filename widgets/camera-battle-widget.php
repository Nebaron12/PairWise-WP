...
class Camera_Battle_Widget extends \Elementor\Widget_Base {
    
    public function get_name() {
        return 'camera_battle';
    }
    
    public function get_title() {
        return esc_html__('Camera Battle', 'camera-battle');
    }
    ...
    public function get_keywords() {
        return ['camera', 'battle', 'comparison', 'vote', 'image', 'test'];
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'content_section',
            [
                'label' => esc_html__('Content', 'camera-battle'),
        ...
        $this->add_control(
            'heading_text',
            [
                'label' => esc_html__('Heading Text', 'camera-battle'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__('Which photo looks better?', 'camera-battle'),
                'placeholder' => esc_html__('Enter your heading', 'camera-battle'),
            ]
        );
        ...
        $this->add_control(
            'completion_text',
            [
                'label' => esc_html__('Completion Text', 'camera-battle'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__('All battles complete! Thanks for voting.', 'camera-battle'),
                'placeholder' => esc_html__('Enter completion message', 'camera-battle'),
            ]
        );
        ...
        $this->add_control(
            'reset_button_text',
            [
                'label' => esc_html__('Reset Button Text', 'camera-battle'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__('Restart', 'camera-battle'),
                'placeholder' => esc_html__('Enter button text', 'camera-battle'),
            ]
        );
        ...
        $this->start_controls_section(
            'images_section',
            [
                'label' => esc_html__('Images', 'camera-battle'),
                'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
            ]
        );
        ...
        $repeater->add_control(
            'image',
            [
                'label' => esc_html__('Choose Image', 'camera-battle'),
        ...
        $repeater->add_control(
            'image_title',
            [
                'label' => esc_html__('Image Title', 'camera-battle'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__('Image', 'camera-battle'),
                'placeholder' => esc_html__('Enter image title', 'camera-battle'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    [
                        'image_title' => esc_html__('Camera A', 'camera-battle'),
                        'image' => ['url' => \Elementor\Utils::get_placeholder_image_src()],
                    ],
                    [
                        'image_title' => esc_html__('Camera B', 'camera-battle'),
                        'image' => ['url' => \Elementor\Utils::get_placeholder_image_src()],
                    ],
                    [
                        'image_title' => esc_html__('Camera C', 'camera-battle'),
                        'image' => ['url' => \Elementor\Utils::get_placeholder_image_src()],
                    ],
                    [
                        'image_title' => esc_html__('Camera D', 'camera-battle'),
                        'image' => ['url' => \Elementor\Utils::get_placeholder_image_src()],
                    ],
                ],
        ...
        $this->start_controls_section(
            'settings_section',
            [
                'label' => esc_html__('Settings', 'camera-battle'),
                'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
            ]
        );
        ...
        $this->add_control(
            'shuffle',
            [
                'label' => esc_html__('Randomize Order', 'camera-battle'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Yes', 'camera-battle'),
                'label_off' => esc_html__('No', 'camera-battle'),
                'return_value' => 'yes',
                'default' => 'yes',
            ]
        );
        ...
        $this->add_control(
            'show_progress',
            [
                'label' => esc_html__('Show Progress Bar', 'camera-battle'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Yes', 'camera-battle'),
                'label_off' => esc_html__('No', 'camera-battle'),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'base_session',
            [
                'label' => esc_html__('Base Session Name', 'camera-battle'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => 'camera-battle',
                'description' => esc_html__('Used for grouping results. Will be appended with timestamp.', 'camera-battle'),
            ]
        );
        ...
        $this->add_control(
            'webhook_url',
            [
                'label' => esc_html__('Webhook URL (Optional)', 'camera-battle'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'placeholder' => esc_html__('https://example.com/webhook', 'camera-battle'),
                'description' => esc_html__('Send data to external service (advanced).', 'camera-battle'),
            ]
        );
        ...
        $this->start_controls_section(
            'style_section',
            [
                'label' => esc_html__('Style', 'camera-battle'),
        ...
        $this->add_control(
            'heading_color',
            [
                'label' => esc_html__('Heading Color', 'camera-battle'),
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__('Heading Typography', 'camera-battle'),
        ...
        $this->add_control(
            'card_border_radius',
            [
                'label' => esc_html__('Card Border Radius', 'camera-battle'),
        ...
        $this->add_control(
            'button_bg_color',
            [
                'label' => esc_html__('Button Background', 'camera-battle'),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'button_text_color',
            [
                'label' => esc_html__('Button Text Color', 'camera-battle'),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
    ...
    protected function render() {
        ...
        $base_session = !empty($settings['base_session']) ? esc_attr($settings['base_session']) : 'camera-battle';
